"""Manager-facing pages: reports, assigned plans, plan assignment."""
...
def manager_plans():
    ...
    for emp in employees:
        plan = db.session.get(OnboardingPlan, emp.onboarding_plan_id)
        if not plan:
            continue
...
def assign_plan():
    ...
    # No sections in the template -> nothing to land on; go home.
